...
<meta property="og:image" content="http://bitroad.org/images/fullLogo.png" />
				...
				<div class="row">				
					<div id="share-buttons-modal">
						<div class="row absolute-center">
							...
							<!-- Facebook -->
							<a href="http://www.facebook.com/sharer.php?appid=1227412770623232&u=<?php echo $page_link ?>&name=bitroad&caption=bitroad&description=<?php echo $post_title?>&picture=http://www.bitroad.org/images/fullLogo.png" target="_blank">
...
<div class="col-xs-12 col-sm-8 col-sm-offset-2">
		<div class="row" >
			<div class="col-xs-12" id="post-wrapper" style="padding: 0px 40px 0px 40px;">
				<div class="row" >
				<div class="xs-hidden"></div>
						<div class="col-xs-3">
							<a href="home.php?loc=<?php echo $post_info['location'] ?> "><img src="images/fullLogo.png" id="logo"></img></a>					
						</div>
						<div class="col-xs-9 post-header">
							<div class="col-xs-7">	
								<h4> 
									  <?php
									  echo '<u>
												<a href="home.php?loc='.$post_info['location'].'">'.$post_info['location'].'</a> <br class="mobile-fix">
							...
							<div class="col-xs-4">	
								<h4 id="post-date" class="post-info-mobile-fix"><?php echo $fgmembersite->humanTiming(strtotime($post_info['date'])); ?> </h4>					
							</div>	
							<!-- <hr class="mobile-fix" style="border-color: white"/><hr class="mobile-fix" style="border-color: white"/> -->
							<div class="col-xs-1" style="padding-left: 0;">	
								<h4 class="glyphicon glyphicon-heart post-info-mobile-fix" id="post-like"></h4>
							</div>
						</div>
				...
				<div class="row" id="post-details" >				
					<div class="col-xs-12">	
							<div class="col-xs-6 col-sm-4 post-detail-item" id="price" style="font-size: 14px;">
							...
							<div class="col-xs-6 col-sm-4 post-detail-item" id="spec-location" style="font-size: 14px;">
								<?php if ($post_info['specific_location'] != '') {echo $post_info['specific_location'];} else {echo '';} ?>
							</div>	
				...
				<?php if ($post_info['img_folder'] != 'images/postImages/default/') { ?>				
					<div class="col-xs-12">		
							<div id="main-photo-area" class="col-sm-6 col-sm-offset-3 col-xs-12">
			...
			<?php } ?>                               
												...
												$count = 0;
													...
													while($file = readdir($handle)){
														...
														if($file !== '.' && $file !== '..'){	
															...
															echo '<li class="col-sm-2 thumb-container">
				...
				<div class="row" id="main_description_area" style="text-transform: none; ">					
					<div class="col-sm-12">
						<div class="jumbotron" style="background-color: #fff;">
							<button class="btn btn-default" style="background-color: #fff;" id="contact-button" style="float: left;" onclick="getContactInfo();"> contact </button>
							<tr >							
								<span id="contact-info"></span>
							</tr>
							<br/><br/>
							 <p style="font-size: 15px; font-weight: normal !important" id="description"><?php echo $post_info['description'] ?>	</p>						
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="col-xs-12 col-sm-2"><p style="float: left;"><b/>id:</b> <?php echo $post_id ?> </p>			</div>
						<div class="spam col-xs-10 col-sm-8">				
							<div class="col-xs-12" style="padding: 0;">	<?php if ($post_info['noSpam'] = 1) { echo '<i>please do not contact me with unsolicited services or offers.</i> ';}?></div>							
							<div class="col-xs-12" style="padding: 10px 0px 0px 0px;">	
								<div id="share-buttons" style="margin-left: auto; margin-right: auto;">
									<!-- Email -->
									<a href="mailto:?Subject=check this out on bitroad&amp;Body=<?php echo $page_link; ?> ">
										<img src="https://simplesharebuttons.com/images/somacro/email.png" alt="Email" />
									</a>
						...
						<div class="col-xs-2">
							<form class="form-horizontal" id="flag-post" method="POST" action="flagPost.php" enctype="multipart/form-data" style="float: right;">			
								...
								<button id="flag-btn" style="border: none; background: none;"><i class="glyphicon glyphicon-flag"></i></button>
							</form>
						</div>
					</div>
				</div>
	...
	function getContactInfo() {
		$.ajax({											
				...
				success: function(data){					
					...
					$('#contact-info').html('<p style="font-size: 14px !important; display: inline;"><i class="glyphicon glyphicon-envelope" style="padding-right: 10px;"></i>' + email + '<i class="glyphicon glyphicon-phone" style="padding-left: 20px; padding-right: 10px;"></i>' + phone + '</p>');
