...
<hr class="filler"style="border-color: white;"/>
<hr class="filler"style="border-color: white;"/>			
				<center><a href="#" data-toggle="modal" data-target="#chatModal"><h3 class="glyphicon glyphicon-leaf chatLink" id="cl-desktop"></h3></a></center>
			<hr class="filler"style="border-color: white;"/>		
			<hr class="filler"style="border-color: white;"/>
 ...
 for ($i = 0; $i < sizeOf($categories); $i++) 
						...
						?>
							<tr>
								<td class="chatLink"><a href="#" data-toggle="modal" data-target="#chatModal" style="display: block;"><h5 class="glyphicon glyphicon-leaf" ></h5></a></td>										
							</tr>
							<tr>
