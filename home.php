...
<hr class="filler" style="border-color: white;"/>
			<div class="row" id="middle-left-sidebar" style="text-align: center;">
				<center><a href="search.php?loc=<?php echo $location ?>&c=<?php echo 'buy cryptocurrency';?>"><p style="font-size: 16px" id="buy-currency" class="text-center">Buy Cryptocurrency</p></a></center>			
				<center><a href="search.php?loc=<?php echo $location ?>&c=<?php echo 'sell cryptocurrency';?>"><p style="font-size: 16px" id="sell-currency" class="text-center">Sell Cryptocurrency</p></a></center>
				<center><a href="http://www.leyff.com" target="blank"><h5 class="text-center" id="crypto-stores">Crypto Stores</h5></a></center>
			</div>
<hr class="filler"style="border-color: white;"/>
<hr class="filler"style="border-color: white;"/>
				<center><a href="chat/index.html" target="blank"><p>Bit Road Chat</p><img class="chatLink" id="cl-desktop" src="images/Globe.png" style="height: 50px; width: 50px;"></img></a></center>
			<hr class="filler"style="border-color: white;"/>
			<hr class="filler"style="border-color: white;"/>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 jumbotron" id="main-content">
			...
			<div class="row" id="header">
				<div class="absolute-center">
					<a href="saved.php"><h2 class="glyphicon glyphicon-heart" style="color: red;"></h2></a>
				</div>
			</div>
...
if ($categories[$i]['category_name'] != 'buy cryptocurrency' && $categories[$i]['category_name'] != 'sell cryptocurrency') {						
					...
					<div class="table-responsive">
					 <table class="table" style="text-align: left;">
						...
						<?php
								for ($i = 0; $i < sizeOf($categories); $i++)
								{
									if ($categories[$i]["category_name"] != NULL) {
						...
						?>
							<!-- <tr>
								<td class="chatLink"><a href="chat/index.html" target="blank" style="display: block;"><img src=""></img></a></td>
							</tr> -->
							<tr>
			...
			<br/>
			<div class="row">
				<div id="crypto-images">
					<div class= "col-xs-12" style="padding-top: 10px; max-height: 100%;">
						<div class="absolute-center">
							<img class="img img-responsive" id="openbazaar-img" onclick="location.href='http://bitroad.org/openbazaar.php'" style="height: 50px; width: 50px; margin-right: 50px;" src="https://p4.zdassets.com/hc/settings_assets/615821/200087229/PwK89nHvKL2w38lG4d4xtw-openbazaar-logo.png"></img>
							<a href="https://bitcoin.org/bitcoin.pdf"><img class="img-responsive" src="images/bitcoin.png" style="height: 50px; width: 50px;"></img></a>
							<img class="img img-responsive" style="height: 50px; width: 50px; margin-left: 50px;" src="images/Hello.png"></img>
						</div>
					</div>
				</div>
			</div>
